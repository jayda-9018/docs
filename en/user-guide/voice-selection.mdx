...
Once you've found a voice ID, refer to the [TTS Call Guide](/en/user-guide/text-to-speech) to continue with text input, parameter settings, and audio output format specification.
