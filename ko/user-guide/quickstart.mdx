...
<Frame>
    <img src="/images/supertone-play-copy-voice-id-preset.png" />
</Frame>

클론드 보이스 역시 같은 방법으로 `voice_id`를 복사할 수 있습니다.

<Frame>
    <img src="/images/supertone-play-copy-voice-id-cloned.png" />
</Frame>
...
```http
POST /text-to-speech/e5f6fb1a53d0add87afb4f
